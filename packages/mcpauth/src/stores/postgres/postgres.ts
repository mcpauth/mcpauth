...
// Kysely uses an interface to strongly type the database schema.
...
interface DB {
  ...
  oauth_token: {
    ...
    scope: string | null;
    authorization_details: any; // JSONB
    client_id: string;
    user_id: string;
  };
  ...
  return {
      ...
      await db
        ...
        .values({
          ...
          scope: Array.isArray(token.scope)
            ? token.scope.join(" ")
            : token.scope,
          authorization_details: token.authorizationDetails,
          client_id: client.id,
          user_id: user.id,
        })
        .execute();
    ...
    async getAccessToken(accessToken: string): Promise<OAuthToken | null> {
      ...
      return {
        ...
        authorizationDetails: t.authorization_details,
        client,
        user,
      };
    },
    ...
    async saveAuthorizationCode(
      ...
      await db
        ...
        .values({
          ...
          scope: scope,
          authorization_details: code.authorizationDetails,
          client_id: client.id,
          user_id: user.id,
    ...
    async getAuthorizationCode(
      ...
      return {
        ...
        authorizationDetails: a.authorization_details,
        client: client,
        user: user,
    ...
    async registerClient(
      ...
      return {
        ...
        token_endpoint_auth_method:
          newClient.token_endpoint_auth_method as TokenEndpointAuthMethod,
      };
    },
  };
}
